...
urls = [
    "https://es.wikipedia.org/wiki/Liga_de_Campeones_de_la_UEFA_2021-22#Cuartos_de_final",
    "https://es.wikipedia.org/wiki/Liga_de_Campeones_de_la_UEFA_2020-21#Cuartos_de_final",
    "https://es.wikipedia.org/wiki/Liga_de_Campeones_de_la_UEFA_2019-20#Cuartos_de_final",
    "https://es.wikipedia.org/wiki/Liga_de_Campeones_de_la_UEFA_2018-19#Cuartos_de_final",
    "https://es.wikipedia.org/wiki/Liga_de_Campeones_de_la_UEFA_2017-18#Cuartos_de_final"
]
...
for url in urls:
    ...
    cuartos_html = soup.find('span', id='Cuartos_de_final').find_next('table', class_='wikitable')

    # Obtenemos las filas de la tabla
    filas = cuartos_html.find_all('tr')
